...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String MOVIE_ID = "ccl.kustom89.moviestowatch.KEY.MOVIE_ID";
        ...
        save.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(name .trim().length()>0){
                    ...
                    Toast.makeText( MainActivity.this, "Movie Saved", Toast.LENGTH_SHORT ).show();
        ...
        last.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(size>0){
                    ...
                    Toast.makeText( MainActivity.this, "Hasn´t Movies", Toast.LENGTH_SHORT ).show();
                }
    ...
    private List<Movie> getMovies(){
        return Movie.find( Movie.class, "watched=0"/*corregir por 0 de ser necesario*/);
    }
